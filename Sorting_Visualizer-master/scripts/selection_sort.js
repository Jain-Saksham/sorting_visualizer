...
{
    document.getElementById("Info_Cont1").innerHTML= "Best Case Complexity for Selection Sort is Ω(n^2)";
    document.getElementById("Info_Cont2").innerHTML= "Worst Case Complexity for Selection Sort is O(n^2)";
    c_delay=0;

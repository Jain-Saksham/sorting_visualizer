...
function Quick()
{
    document.getElementById("Info_Cont1").innerHTML= "Best Case Complexity for Quick Sort is Ω(nlogn)";
    document.getElementById("Info_Cont2").innerHTML= "Worst Case Complexity for Quick Sort is O(n^2)";
    c_delay=0;
...
function quick_partition (start, end)
{
    ...
    div_update(divs[start],div_sizes[start],"lemon");//Color update
